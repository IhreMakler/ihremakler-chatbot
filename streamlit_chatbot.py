...
# Eingabefeld und Button in einer Zeile (nur HTML, kein Streamlit-Input mehr)
st.markdown("""
<div style="display: flex; gap: 1rem; align-items: center; margin-bottom: 2rem;">
  <input type="text" id="chat_input" name="chat_input" placeholder="Stellen Sie eine Frage..." style="flex: 1; padding: 0.8rem; border: 1px solid #3B8EA0; border-radius: 4px; font-family: Arial, Verdana, sans-serif; font-size: 1rem;">
