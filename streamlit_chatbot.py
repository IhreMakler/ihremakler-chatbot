...
# Eingabefeld und Button nebeneinander, Button rechtsbündig
st.markdown("""
<style>
...
with col1:
    user_input = st.text_input("", placeholder="Stellen Sie eine Frage...", key="chat_input")
    # Enter-Taste sendet die Frage, indem das Feld nach Senden geleert wird
    if user_input and st.session_state.get('enter_sent', False):
        st.session_state.chat_messages.append({"role": "user", "content": user_input})
        st.session_state["chat_input"] = ""
        st.session_state.enter_sent = False
        try:
