...
# Eingabefeld und Button nebeneinander, Button rechts neben dem Feld
st.markdown("""
<style>
...
row = st.columns([8,1])
user_input = row[0].text_input("", placeholder="Stellen Sie eine Frage...", key="chat_input")
send_button = row[1].button("Senden", use_container_width=True)
