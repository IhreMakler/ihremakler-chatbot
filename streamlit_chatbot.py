...
with col1:
    user_input = st.text_input("Ihre Frage:", placeholder="Stellen Sie eine Frage...")
with col2:
...
<div class="footer-container">
    <div class="footer-content">
        ...
        <div class="footer-section">
            <h4>Kontakt</h4>
            <ul>
                <li><a href="mailto:info@ihremakler.online">info@ihremakler.online</a></li>
                <li><a href="tel:+49303039828">+49 30 30398 281</a></li>
                <li><a href="https://www.ihremakler.online/kontakt/">Kontaktformular</a></li>
            </ul>
        </div>
    </div>
    
    <div class="footer-bottom">
        <p><span class="footer-logo">IhreMakler</span> • <span class="footer-tagline">Lokal. Schnell. Fair.</span></p>
        <p style="margin-top: 0.5rem; color: #999;">© 2024 IhreMakler. Alle Rechte vorbehalten.</p>
    </div>
</div>
""", unsafe_allow_html=True)
